...
const INDIAN_FIRST_NAMES = [
    // Male names
    "Arjun", "Vikram", "Rohit", "Amit", "Suresh", "Rajesh", "Anil", "Deepak", "Vinay", "Karan",
    "Ravi", "Sanjay", "Nitin", "Manoj", "Sachin", "Rahul", "Vishal", "Ashish", "Pradeep", "Ajay",
    "Ankit", "Gaurav", "Harsh", "Pavan", "Shivam", "Neeraj", "Tarun", "Yogesh", "Sandeep", "Akash",
    "Dev", "Jai", "Krishna", "Aryan", "Varun", "Abhishek", "Siddharth", "Manish", "Naveen", "Kartik",
    "Ramesh", "Mukesh", "Sunil", "Arun", "Vivek", "Mahesh", "Dinesh", "Jatin", "Nikhil", "Rohan",
    // Female names
    "Priya", "Anita", "Sunita", "Kavya", "Shreya", "Pooja", "Neha", "Riya", "Sonia", "Meera",
    "Deepika", "Aisha", "Nisha", "Rekha", "Geeta", "Maya", "Divya", "Ritu", "Swati", "Kiran",
    "Anjali", "Shweta", "Preeti", "Seema", "Madhuri", "Asha", "Usha", "Radha", "Lata", "Sita",
    "Aditi", "Sneha", "Tanvi", "Ishita", "Simran", "Pallavi", "Ruchi", "Vidya", "Nidhi", "Jyoti"
];

const INDIAN_LAST_NAMES = [
    "Sharma", "Gupta", "Singh", "Kumar", "Agarwal", "Verma", "Jain", "Patel", "Shah", "Mehta",
    "Reddy", "Rao", "Nair", "Pillai", "Iyer", "Krishnan", "Menon", "Bhat", "Shetty", "Kulkarni",
    "Desai", "Joshi", "Pandey", "Tiwari", "Mishra", "Srivastava", "Chandra", "Bansal", "Goyal", "Mittal",
    "Chopra", "Malhotra", "Kapoor", "Arora", "Batra", "Khanna", "Sethi", "Aggarwal", "Goel", "Saxena",
    "Bhatt", "Thakur", "Choudhary", "Sinha", "Dixit", "Tripathi", "Dubey", "Shukla", "Pathak", "Bajaj"
];
...
const INDIAN_STATES = [
    ...
    "West Bengal", "Madhya Pradesh", "Kerala", "Punjab", "Haryana", "Bihar", "Odisha",
    "Telangana", "Andhra Pradesh", "Jharkhand", "Assam", "Chhattisgarh", "Uttarakhand", "Himachal Pradesh"
];

const COMPANIES = [
    "Tech Solutions Pvt Ltd", "InfoSys Technologies", "Digital Innovations", "Smart Systems",
    "Future Tech Corp", "Global Solutions", "Advanced Analytics", "DataTech Services",
    "CloudFirst Technologies", "Enterprise Solutions", "NextGen Software", "Innovative Minds",
    "TechnoSoft India", "Digital Dynamics", "Smart Solutions Ltd", "Tech Ventures",
    "Innovation Hub", "Software Specialists", "Tech Pioneers", "Digital Leaders"
];
        ...
        for (let i = 0; i < count; i++) {
            try {
                ...
                if (response.status === 201) {
                    ...
                    failedLeads++;
                    const errorText = await response.text();
                    console.log(`⚠️  Failed to create lead ${i + 1}: ${response.status} - ${errorText}`);
                    
                    // If it's still 401, show debug info for first failure
                    if (response.status === 401 && i === 0) {
                        const cookies = cookieJar.getCookiesSync(BASE_URL);
                        console.log(`🔍 Debug - Current cookies:`, cookies.map(c => `${c.key}=${c.value.substring(0, 20)}...`));
                    }
                }
